...
[![My Skills](https://skillicons.dev/icons?i=c,cpp,bootstrap,css,sass,figma,firebase,git,github,html,js,java,md,mysql,ps,php,pr,redux,styledcomponents,vscode,tailwind,python,react,vite,nextjs,mongodb,nodejs,expressjs,materialui,androidstudio&perline=10)](https://skillicons.dev)
