...
<a href="https://www.linkedin.com/in/ansh-tripathi-dev/" target="_blank">
  <img
    align="center"
    src="https://cdn.jsdelivr.net/npm/simple-icons@3.1.0/icons/linkedin.svg"
    alt="ansh-tripathi-dev"
    height="30"
    width="40"
    style="fill: blue;"
  />
...
[![My Skills](https://skillicons.dev/icons?i=c,cpp,bootstrap,css,sass,figma,firebase,git,github,html,js,ts,java,md,mysql,ps,php,pr,redux,styledcomponents,vscode,tailwind,python,react,vite,nextjs,mongodb,nodejs,expressjs,materialui,androidstudio&perline=10)](https://skillicons.dev)
