...
[![My Skills](https://skillicons.dev/icons?i=c,cpp,bootstrap,css,figma,firebase,git,github,html,js,java,md,mysql,ps,php,pr,redux,styledcomponents,vscode,tailwind,python,react,nextjs,materialui,androidstudio&perline=10)](https://skillicons.dev)
